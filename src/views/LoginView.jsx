  ...
  return (
    <div className="min-h-screen bg-slate-100 flex items-center justify-center p-4">
      <div className="w-full max-w-md rounded-3xl border border-slate-200 bg-white p-8 shadow-lg">
        <h1 className="mb-1 text-2xl font-extrabold text-slate-900">Healthy Diet Login</h1>
        <p className="mb-5 text-sm text-slate-500">登入後會儲存 token、refreshToken、expiresIn、user.role</p>
